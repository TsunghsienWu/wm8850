...
extern int gpio_enable(GPIO_CTRL *gp_ctrl, GPIO_IN_OUT mode);
extern int gpio_set_value(GPIO_CTRL *gp_ctrl,GPIO_OUTPUT value);
extern int gpio_get_value(GPIO_CTRL *gp_ctrl);
extern int gpio_pull_enable(GPIO_CTRL *gp_ctrl,GPIO_PULL pull_mode);

/*interruption related API*/
extern int enable_gpio_int(GPIO_CTRL *gp_ctrl, GPIO_INT_ENA enable);
extern int set_gpio_irq_triger_mode(GPIO_CTRL *gp_ctrl, GPIO_IRQ_TRIGER_MODE trigger_mode);
extern int gpio_irq_state(GPIO_CTRL *gp_ctrl);
extern int gpio_clean_irq_status(GPIO_CTRL *gp_ctrl);
extern int gpio_irq_isEnable(GPIO_CTRL *gp_ctrl);
