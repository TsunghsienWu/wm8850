...
#define rtw_usb_buffer_alloc(dev, size, mem_flags, dma) wmt_usb_alloc_coherent((dev), (size), (mem_flags), (dma))
#define rtw_usb_buffer_free(dev, size, addr, dma) wmt_usb_free_coherent((dev), (size), (addr), (dma))
#else
