...
static struct resource wmt_pdm_resources[] = {
    [0] = {
		.start  = 0xD82D0000,
		.end    = 0xD82D0000 + 0x4f,
		.flags  = IORESOURCE_MEM,
...
static u64 wmt_pdm_dma_mask = 0xffffffffUL;
...
static struct platform_device wmt_pdm_device = {
	.name           = "wmt-pdm",
	.id             = 0,
	.dev            = {
	.dma_mask 		= &wmt_pdm_dma_mask,
	.coherent_dma_mask = ~0,
	},
	.num_resources  = ARRAY_SIZE(wmt_pdm_resources),
	.resource       = wmt_pdm_resources,
};

static struct platform_device wmt_pdm_pcm_device = {
	.name           = "wmt-pdm-pcm",
	.id             = 0,
};
...
#ifdef CONFIG_SND_SOC_WMT_FM34
static struct i2c_board_info fm34_i2c_dev[] __initdata = {
...
#ifdef CONFIG_SND_SOC_WMT_FM34
	i2c_register_board_info(0, fm34_i2c_dev, ARRAY_SIZE(fm34_i2c_dev)); //wmt-fm34: i2c-0
#endif

	i2c_register_board_info(0, cp2682_i2c_dev, ARRAY_SIZE(cp2682_i2c_dev));
