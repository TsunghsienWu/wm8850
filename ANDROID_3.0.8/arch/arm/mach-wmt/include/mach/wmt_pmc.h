...
#define PMEBM_ADDR 	 		(__PMC_BASE + 0x038C)     /* MALI */
#define PMEBMH_ADDR 	  (__PMC_BASE + 0x038D)
...
#define PMMALIPPPWR_ADDR	(__PMC_BASE + 0x0600)		/* MALI PP Power Shut Off Control and Status Register */
#define PMC_MPWR_ADDR   (__PMC_BASE + 0x0604)		  /* C&M Power Shut Off Control and Status Register */
#define PMCA9PWR_ADDR 	(__PMC_BASE + 0x0608)		  /* CA9 Power Shut Off Control and Status Register */
#define PML2CRAMPWR_ADDR (__PMC_BASE + 0x060C)		/* L2CRAM Power Shut Off Control and Status Register */
#define PMNEONPWR_ADDR 	(__PMC_BASE + 0x0610)		  /* NEON Power Shut Off Control and Status Register */
#define PMMALIL2CPWR_ADDR	(__PMC_BASE + 0x0600)		/* MALI L2C Power Shut Off Control and Status Register */
...
#define DVFSSTS_VAL   (REG32_PTR(DVFSSTS_ADDR))
#define DVFSE0_VAL    (REG32_PTR(DVFSE0_ADDR))    
#define DVFSE1_VAL    (REG32_PTR(DVFSE1_ADDR))    
#define DVFSE2_VAL    (REG32_PTR(DVFSE2_ADDR))    
#define DVFSE3_VAL    (REG32_PTR(DVFSE3_ADDR))    
#define DVFSE4_VAL    (REG32_PTR(DVFSE4_ADDR))    
#define DVFSE5_VAL    (REG32_PTR(DVFSE5_ADDR))    
#define DVFSE6_VAL    (REG32_PTR(DVFSE6_ADDR))    
#define DVFSE7_VAL    (REG32_PTR(DVFSE7_ADDR))    
#define DVFSE8_VAL    (REG32_PTR(DVFSE8_ADDR))    
#define DVFSE9_VAL    (REG32_PTR(DVFSE9_ADDR))    
#define DVFSE10_VAL   (REG32_PTR(DVFSE10_ADDR))    
#define DVFSE11_VAL   (REG32_PTR(DVFSE11_ADDR))    
#define DVFSE12_VAL   (REG32_PTR(DVFSE12_ADDR))    
#define DVFSE13_VAL   (REG32_PTR(DVFSE13_ADDR))    
#define DVFSE14_VAL   (REG32_PTR(DVFSE14_ADDR))    
#define DVFSE15_VAL   (REG32_PTR(DVFSE15_ADDR))
